...
O sistema DEVE permitir o cadastro de uma pessoa informando nome, telefone e, opcionalmente, idade. O sistema DEVE validar os dados de entrada antes de persistir o cadastro.

#### Scenario: Cadastro realizado com sucesso
- **WHEN** o cliente envia uma requisição de cadastro com nome e telefone válidos
...
- **THEN** o sistema aceita o cadastro normalmente, sem exigir esse campo
